...
//               key={index}
//               onClick={() => handleMovieClick(title)} // 클릭 시 페이지 이동
//               className="flex items-end h-40 p-5 font-bold text-black transition-transform duration-300 transform bg-gray-400 rounded-lg cursor-pointer hover:scale-105 active:scale-95 active:bg-gray-100"
//             >
//               <div>
//                 <div className="text-left">{title}</div>
//                 <div className="mt-1 text-sm font-normal">영화</div>
